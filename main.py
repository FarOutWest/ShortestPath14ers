"""
Randy Olson's Shortest Route Program modified By Andrew Liesinger and now West Castro* to:
...
GOOGLE_MAPS_API_KEY = "AIzaSyApNLrGE4xTbl2dkaZpsEAOF38_nt7feus"
...
# all_waypoints = ["Mt.Elbert, Colorado",
#                     "Mt.Massive, Colorado",
#                     "Mt.Harvard, Colorado",
#                     "Blanca Peak, Colorado",
#                     "LaPlata Peak, Colorado",
    ...
    for generation in range(generations):
        ...
        for rank, agent_genome in enumerate(sorted(population_fitness,
            ...
            if (generation % generations_10pct == 0 or generation == generations - 1) and rank == 0:
                ...
                print("AGENT_GENOME: ", agent_genome, "\n")
